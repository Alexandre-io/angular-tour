 ...
 * @version v0.2.0 - 2015-06-26
 * @link https://github.com/Alexandre-io/angular-tour
 * @author Tyler Henkel
...
(function (window, document, undefined) {
  'use strict';
  angular.module('angular-tour-new', [
    'angular-tour-new.tpls',
    'angular-tour-new.tour'
  ]);
  angular.module('angular-tour-new.tpls', ['tour/tour.tpl.html']);
  ...
  angular.module('angular-tour-new.tour', []).constant('tourConfig', {
    placement: 'top',
    animation: true,
    nextLabel: 'Next',
    scrollSpeed: 500,
